        ...
        <div class="container-fluid mt-3" style="min-height: 90vh" >
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <a class="btn btn-light border" href="product/new">Crear producto</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <a href="product?id=${product.getId()}" class="btn btn-light border"><i class="fa-solid fa-eye"></i></a>
                                        <a onclick="deletedProduct(${product.getId()})" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                        </c:forEach>
